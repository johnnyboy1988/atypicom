async function loadComponents() {
  const components = [
    ...
    { id: 'arena-container', path: './components/arena.html' },
    { id: 'choices-player1-container', path: './components/choices-player1.html' },
    { id: 'choices-player2-container', path: './components/choices-player2.html' }
  ];
